...
def model(request):
    if request.method == "POST":
        ...
        models = keras.models.load_model('C:/Users/harsh/Music/ITPSG05-FINAL/ITPSG05-FINAL CODING/Deploy/Project/App/LENET.h5')
        data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)
        image = Image.open("C:/Users/harsh/Music/ITPSG05-FINAL/ITPSG05-FINAL CODING/Deploy/Project/" + str(result)).convert("RGB")
        size = (224, 224)
        ...
        a = (classes[idd])
        if a == 'benign':
            b = 'THE BREAST CANCER IS IN THE CONDITION OF BENIGN. THIS STAGE 1 BREAST CANCER.'
            models = load_model('C:/Users/harsh/Music/ITPSG05-FINAL/ITPSG05-FINAL CODING/Deploy/Project/App/BENIGN.h5')
            test_image = 'C:/Users/harsh/Music/ITPSG05-FINAL/ITPSG05-FINAL CODING/Deploy/Project/' + str(result)
            ...
            b = 'THE BREAST CANCER IS IN THE CONDITION OF MALIGNANT. THIS STAGE 2 BREAST CANCER.'
            models = load_model('C:/Users/harsh/Music/ITPSG05-FINAL/ITPSG05-FINAL CODING/Deploy/Project/App/MALIGNANT.h5')
            test_image = 'C:/Users/harsh/Music/ITPSG05-FINAL/ITPSG05-FINAL CODING/Deploy/Project/' + str(result)
            y = read_image(test_image)
            y_pred = models.predict(y)[0] > 0.5
            y_pred = np.squeeze(y_pred, axis=-1)
            ...
            b = 'THE BREAST CANCER IS IN THE CONDITION OF NORMAL.'
            models = load_model('C:/Users/harsh/Music/ITPSG05-FINAL/ITPSG05-FINAL CODING/Deploy/Project/App/NORMAL.h5')
            test_image = 'C:/Users/harsh/Music/ITPSG05-FINAL/ITPSG05-FINAL CODING/Deploy/Project/' + str(result)
            y = read_image(test_image)
            y_pred = models.predict(y)[0] > 0.5
            y_pred = np.squeeze(y_pred, axis=-1)
        ...
        data.label = a
        data.save()
        return render(request, 'App/output.html',{'form':form,'obj':obj,'image_uri': image_uri,'predict':a})
